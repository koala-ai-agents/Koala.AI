            ...
            def submit_step(nid: str):
                ...
                if guards:
                    try:
                        ...
                        raise FlowError(f"Guard pre-step failed for {step.id}: {e}")
            ...
            while futures:
                ...
                for fut in done:
                    ...
                    try:
                        ...
                        raise FlowError(f"Step {nid} failed: {exc}")
                    ...
                    if guards:
                        try:
                            ...
                            raise FlowError(f"Guard post-step failed for {nid}: {e}")
    ...
    def run_state_machine(
        ...
        for ev in events:
            ...
            if st.action:
                ...
                # call maybe async
                res = self._call_maybe_async(func, **resolved_args)
            ...
            while futures:
                ...
                for fut in done:
                    ...
                    try:
                        ...
                        raise FlowError(f"Step {nid} failed in remote executor: {exc}")
                    results[nid] = res
                    for m in outgoing.get(nid, []):
                        incoming[m] -= 1
                        if incoming[m] == 0:
